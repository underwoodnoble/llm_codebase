...
from ..arguments import (SFTTrainingArguments, SFTDataArguments, RMDataArguments, RMTrainingArguments,
    ...
    PPOv2DataArguments, PPOv2TrainingArguments)
...
def get_args():
    ...
    subparsers.add_parser('ppo_v2', help='Using PPO parser')
    ...
    elif algorithm_args.algorithm == 'ppo_v2':
        subparser = HfArgumentParser((PPOv2TrainingArguments, PPOv2DataArguments))
